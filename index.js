...
async function run() {
  try {
    ...
    app.post("/payments", async (req, res) => {
      ...
      // send user email about payment confirmation ***Not working>>

      mg.messages
        .create(process.env.MAIL_SENDING_DOMAIN, {
          from: "Mailgun Sandbox <postmaster@sandbox194ab4ea5d2645daadb64bae52686575.mailgun.org>",
          to: ["ahiron425@gmail.com"],
          subject: "Restaurant Boss Order Confirmation",
          text: "Testing some Mailgun awesomness!",
          html: `
          <div>
          <h2>Thank you for your order</h2>
          <h4>You transaction id: <strong>${payment.transactionId}</strong></h4>
          <p>We would like get your feedback about the food</p>
          </div>
          `,
        })
     ...
     * ----------------------------------
     * 1. load all payments
     * 2. for every menuItems (which is an array), go find the item for menu collection
     * 3. for item is the menu collection that found from a payment entry (document)
     */
